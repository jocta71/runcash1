...
const strategiesRoutes = require('./routes/strategies'); // Nova rota de estratégias
...
app.use('/api/strategies', strategiesRoutes); // Nova rota para estratégias
...
server.listen(PORT, () => {
  ...
  console.log(`[Server] API Estratégias disponível em /api/strategies`);
});
