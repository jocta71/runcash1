...
export const StrategyDataPanel = ({ roletaId, roletaNome }: StrategyDataPanelProps) => {
  ...
  if (loading) {
    return (
      <div className="w-full bg-black/80 border-2 border-green-400 rounded-md p-3 shadow-lg">
  ...
  if (error) {
    return (
      <div className="w-full bg-black/80 border-2 border-red-400 rounded-md p-3 shadow-lg">
  ...
  return (
    <div className="w-full bg-black/80 border-2 border-green-400 rounded-md p-3 shadow-lg mt-2">
