...
export default async function handler(req, res) {
  ...
  switch (method) {
    case 'POST':
      ...
      break;
    // Exemplo para buscar estratégias (implementar futuramente)
    /*
    case 'GET':
      try {
        // TODO: Adicionar filtro por userId se aplicável
        const strategies = await Strategy.find({}); // Busca todas as estratégias
    ...
    */
    default:
      res.setHeader('Allow', ['POST']); // Adicionar 'GET' quando implementar
