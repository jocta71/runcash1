...
export default function TestWebhook() {
  ...
  const [eventType, setEventType] = useState('checkout.completed');
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="mt-8 bg-gray-800/50 p-4 rounded-lg border border-gray-700">
        ...
        <ol className="list-decimal ml-5 space-y-2 text-sm">
          <li>Selecione o tipo de evento que deseja simular (checkout.completed, subscription.cancelled, etc.)</li>
