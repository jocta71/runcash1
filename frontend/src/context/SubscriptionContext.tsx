    ...
    while (retryCount < maxRetries) {
      try {
        ...
        if (!user.asaasCustomerId) {
          console.log('[SubscriptionContext] Usuário não possui asaasCustomerId');
          // Não tentar criar o cliente, apenas definir o plano free
          handleNoSubscription();
          setError('Seu cadastro no sistema de pagamento não foi concluído. Entre em contato com o suporte.');
          break;
        } else {
