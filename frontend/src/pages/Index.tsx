          ...
          <div className="bg-[#131614]/80 p-10 rounded-xl backdrop-blur-lg shadow-2xl border border-gray-800/50 text-center max-w-xl w-full">
            ...
            <Button 
              onClick={() => {
                ...
                // Simulação da geração de link do Asaas (em produção, seria uma chamada à API)
                setTimeout(() => {
                  setIsProcessingPayment(false);
                  
                  // Aqui seria feito o redirecionamento para a página de checkout do Asaas
            ...
            >
              {isProcessingPayment ? (
                ...
                <>
                  ...
                  Assinar Plano {selectedPlan === "basic" ? "Mensal" : "Anual"}
                </>
              )}
            </Button>
            
            {/* Mensagem informativa abaixo do botão */}
            <p className="text-gray-400 text-xs mt-3">
              Pagamento processado com segurança pelo Asaas
            </p>
            
            {/* Formulário de Checkout - Vamos remover e substituir por um fluxo mais simples */}
            ...
            {paymentSuccess && (
              <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
                <div className="bg-[#131614] rounded-xl shadow-2xl border border-gray-800 max-w-md w-full p-6 relative text-center">
                  ...
                  <h2 className="text-[#00FF00] font-bold text-xl mb-2">Redirecionando para Pagamento</h2>
                  <p className="text-white/80 mb-6">Você está sendo redirecionado para nossa plataforma segura de pagamento.</p>
                  <p className="text-white/60 mb-8 text-sm">O valor será de {selectedPlan === "basic" ? "R$ 49,00 por mês" : "R$ 99,00 por ano"}.</p>
                  
                  <div className="flex flex-col space-y-3">
                    <Button 
                      onClick={() => {
                        // Em produção, esta ação redirecionaria para a URL do Asaas
                        window.open('https://www.asaas.com/checkout', '_blank');
                      }}
