...
const RouletteCard: React.FC<RouletteCardProps> = ({ data, isDetailView = false }) => {
  ...
  return (
    <Card 
      ref={cardRef}
      className={cn(
        "relative overflow-visible transition-all duration-300 backdrop-filter bg-opacity-40 bg-[#22c55e0d] border border-gray-700", 
    ...
    >
      ...
      <CardContent className="p-4 relative z-10">
        ...
        {/* Números recentes */}
        <div className="flex flex-wrap gap-1 justify-center my-5 p-3 rounded-xl">
