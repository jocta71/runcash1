// Redirecionador para /backend/api/payment/asaas-list-payments
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('Erro ao redirecionar solicitação de listagem de cobranças:', error.message);
    ...
    return res.status(500).json({
      success: false,
      error: 'Erro ao processar solicitação de listagem de cobranças',
