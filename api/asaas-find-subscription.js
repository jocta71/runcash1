// Redirecionador para /backend/api/payment/asaas-find-subscription
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('Erro ao redirecionar solicitação de consulta de assinatura:', error.message);
    ...
    return res.status(500).json({
      success: false,
      error: 'Erro ao processar solicitação de consulta de assinatura',
