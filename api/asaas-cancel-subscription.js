// Redirecionador para /backend/api/payment/asaas-cancel-subscription
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('Erro ao redirecionar solicitação de cancelamento de assinatura:', error.message);
    ...
    return res.status(500).json({
      success: false,
      error: 'Erro ao processar solicitação de cancelamento de assinatura',
