...
module.exports = async (req, res) => {
  ...
  // Apenas aceitar GET para obter QR code
  if (req.method !== 'GET') {
  ...
  try {
    ...
    console.log(`Obtendo QR code PIX para pagamento: ${paymentId}`);
    
    // Buscar QR code na API do Asaas
    const response = await axios.get(
      `${API_BASE_URL}/payments/${paymentId}/pixQrCode`,
