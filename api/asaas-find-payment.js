// Redirecionador para /backend/api/payment/asaas-find-payment
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Encaminhar requisição para o backend (incluindo token de autorização e parâmetros de consulta)
    ...
    console.error('Erro ao redirecionar solicitação de busca de pagamento:', error.message);
    ...
    return res.status(500).json({
      success: false,
      error: 'Erro ao processar solicitação de busca de pagamento',
